...
export const DATA_LIBRARIES: readonly WorkspaceEntity[] = [
  {
    ...
    status: 'soon',
    icon: 'CM',
    description: 'Gestion de contenu web et catalogues digitaux. Contenu prochainement disponible.',
  ...
  },
  {
    ...
    status: 'soon',
    icon: 'PI',
    description: 'Product Information Management — référentiel produits. Contenu prochainement disponible.',
  ...
  },
  {
    ...
    status: 'soon',
    icon: 'SC',
    description: 'Supply Chain — achats et fournisseurs. Contenu prochainement disponible.',
  ...
  },
  {
    ...
    status: 'soon',
    icon: 'MR',
    description: 'Planification des besoins en matières (MRP). Contenu prochainement disponible.',
  ...
  },
  {
    ...
    status: 'soon',
    icon: 'ET',
    description: 'Extract, Transform, Load — intégration de données. Contenu prochainement disponible.',
  ...
  },
  {
    ...
    status: 'soon',
    icon: 'ED',
    description: 'Échanges de documents structurés B2B (EDI). Contenu prochainement disponible.',

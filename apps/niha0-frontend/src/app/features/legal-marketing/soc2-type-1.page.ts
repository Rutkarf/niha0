...
@Component({
  selector: 'app-soc2-type-1-page',
  imports: [RouterLink],
  template: `
    <div class="legal-page">
      <article class="legal-card card">
        <h1>Conformité SOC 2 Type 1</h1>
        <p class="updated">Publication prochaine</p>

        <section>
          <h2>Statut</h2>
          <p>
            Cette page accueillera la documentation de conformité SOC 2 Type 1 de NIHAO :
            périmètre des contrôles, attestations et preuves de sécurité pour les organisations
            clientes.
          </p>
        </section>

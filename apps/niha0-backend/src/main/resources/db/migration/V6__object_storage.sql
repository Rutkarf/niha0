-- Object storage metadata (binaries live outside the DB). Base64 logo_url remains as temporary fallback.
...
-- Honest default: uploaded files are not AI-processed until a real pipeline exists.
